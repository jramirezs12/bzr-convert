...
export default function Home() {
  ...
  <p className="w-full text-base sm:text-lg md:text-xl text-gray-700 dark:text-gray-200">
    Convierte tus imágenes a <strong className="font-semibold">WebP, PNG, JPEG o AVIF</strong> en segundos.
  </p>

  <p className="w-full text-sm sm:text-base text-gray-500 dark:text-gray-400">
    Arrastra y suelta tus archivos o haz clic en <span className="font-medium">Agregar imágenes</span>.
  </p>
